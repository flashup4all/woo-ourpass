 ...
 */
class OurPass_Routes_Order_Post extends OurPass_Routes_Route {
	...
	protected function get_shipping( $request ) {
		$shipping_route   = new OurPass_Routes_Shipping( false ); // Instantiate without registering the route.
