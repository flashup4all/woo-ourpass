...
8. If installation was done well, WooCommerce option will appear on the side menu
...
12. Copy the API public and secret Keys found in the setting section of the OurPass merchant account and update it on the Wordpress -> WooCommerce -> settings -> Payment Tab page (OurPass Section)
